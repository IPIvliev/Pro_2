...
class PAJ7620U2(object):
	...
	def start_paj(windows):	
		print("\nGesture Sensor Test Program ...\n")
		paj7620u2=PAJ7620U2()
		
		pajing = Thread(target=PAJ7620U2.go_paj, args=(paj7620u2, windows))
		pajing.daemon = True
		pajing.start()

	def go_paj(paj7620u2, windows):

		while True:
			time.sleep(0.5)
			paj7620u2.check_gesture(windows)
